...
namespace Themis.iOS {
	[Register("TSSession", true)]
	public unsafe partial class TSSession : NSObject, INSObjectProtocol {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("TSSession");
		public override NativeHandle ClassHandle { get { return class_ptr; } }
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public TSSession () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected TSSession (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal TSSession (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public TSSession (NSData userId, NSData privateKey, TSSessionTransportInterface callbacks)
			: base (NSObjectFlag.Empty)
		{
			var userId__handle__ = userId!.GetNonNullHandle (nameof (userId));
			var privateKey__handle__ = privateKey!.GetNonNullHandle (nameof (privateKey));
			var callbacks__handle__ = callbacks!.GetNonNullHandle (nameof (callbacks));
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithUserId:privateKey:callbacks:"), userId__handle__, privateKey__handle__, callbacks__handle__), "initWithUserId:privateKey:callbacks:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("initWithUserId:privateKey:callbacks:"), userId__handle__, privateKey__handle__, callbacks__handle__), "initWithUserId:privateKey:callbacks:");
			}
		}
		...
		[Export ("connect:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool Connect (out NSError? error)
		{
			NativeHandle errorValue = IntPtr.Zero;
			bool ret;
			if (IsDirectBinding) {
				ret = global::ApiDefinition.Messaging.bool_objc_msgSend_ref_NativeHandle (this.Handle, Selector.GetHandle ("connect:"), ref errorValue);
			} else {
				ret = global::ApiDefinition.Messaging.bool_objc_msgSendSuper_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("connect:"), ref errorValue);
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? ConnectRequest (out NSError? error)
		{
			NativeHandle errorValue = IntPtr.Zero;
			NSData? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_ref_NativeHandle (this.Handle, Selector.GetHandle ("connectRequest:"), ref errorValue))!;
			} else {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("connectRequest:"), ref errorValue))!;
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? UnwrapAndReceive (nuint length, out NSError? error)
		{
			NativeHandle errorValue = IntPtr.Zero;
			NSData? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_UIntPtr_ref_NativeHandle (this.Handle, Selector.GetHandle ("unwrapAndReceive:error:"), length, ref errorValue))!;
			} else {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("unwrapAndReceive:error:"), length, ref errorValue))!;
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? UnwrapData (NSData? message, out NSError? error)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool WrapAndSend (NSData? message, out NSError? error)
		{
			var message__handle__ = message.GetHandle ();
			NativeHandle errorValue = IntPtr.Zero;
			bool ret;
			if (IsDirectBinding) {
				ret = global::ApiDefinition.Messaging.bool_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("wrapAndSend:error:"), message__handle__, ref errorValue);
			} else {
				ret = global::ApiDefinition.Messaging.bool_objc_msgSendSuper_NativeHandle_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("wrapAndSend:error:"), message__handle__, ref errorValue);
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? WrapData (NSData? message, out NSError? error)
		{
			var message__handle__ = message.GetHandle ();
			NativeHandle errorValue = IntPtr.Zero;
			NSData? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("wrapData:error:"), message__handle__, ref errorValue))!;
			} else {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("wrapData:error:"), message__handle__, ref errorValue))!;
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		public virtual bool IsSessionEstablished {
			...
			get {
				if (IsDirectBinding) {
					return global::ApiDefinition.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isSessionEstablished"));
				} else {
					return global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("isSessionEstablished"));
				}
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
