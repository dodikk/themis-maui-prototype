...
namespace Themis.iOS {
	[Register("TSMessage", true)]
	public unsafe partial class TSMessage : NSObject, INSObjectProtocol {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("TSMessage");
		public override NativeHandle ClassHandle { get { return class_ptr; } }
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public TSMessage () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected TSMessage (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal TSMessage (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NativeHandle ConstructorInitInEncryptMode (NSData privateKey, NSData peerPublicKey)
		{
			var privateKey__handle__ = privateKey!.GetNonNullHandle (nameof (privateKey));
			var peerPublicKey__handle__ = peerPublicKey!.GetNonNullHandle (nameof (peerPublicKey));
			if (IsDirectBinding) {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initInEncryptModeWithPrivateKey:peerPublicKey:"), privateKey__handle__, peerPublicKey__handle__);
			} else {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("initInEncryptModeWithPrivateKey:peerPublicKey:"), privateKey__handle__, peerPublicKey__handle__);
			}
		}
		[Export ("initInSignVerifyModeWithPrivateKey:peerPublicKey:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NativeHandle ConstructorInitInSignVerifyMode (NSData? privateKey, NSData? peerPublicKey)
		{
			var privateKey__handle__ = privateKey.GetHandle ();
			var peerPublicKey__handle__ = peerPublicKey.GetHandle ();
			if (IsDirectBinding) {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initInSignVerifyModeWithPrivateKey:peerPublicKey:"), privateKey__handle__, peerPublicKey__handle__);
			} else {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("initInSignVerifyModeWithPrivateKey:peerPublicKey:"), privateKey__handle__, peerPublicKey__handle__);
			}
		}
		[Export ("autorelease")]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual TSMessageMode Mode {
			[Export ("mode")]
			get {
				TSMessageMode ret;
				if (IsDirectBinding) {
					ret = (Themis.iOS.TSMessageMode) (long) global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("mode"));
				} else {
					ret = (Themis.iOS.TSMessageMode) (long) global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("mode"));
				}
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData PrivateKey {
			[Export ("privateKey")]
			get {
				NSData? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("privateKey")))!;
				} else {
					ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("privateKey")))!;
				}
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData PublicKey {
			[Export ("publicKey")]
			get {
				NSData? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("publicKey")))!;
				} else {
					ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("publicKey")))!;
				}
				return ret!;
			}
		}
