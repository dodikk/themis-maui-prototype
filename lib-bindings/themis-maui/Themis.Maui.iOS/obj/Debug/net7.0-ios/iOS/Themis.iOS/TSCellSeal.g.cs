...
namespace Themis.iOS {
	[Register("TSCellSeal", true)]
	public unsafe partial class TSCellSeal : TSCell, INSObjectProtocol {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("TSCellSeal");
		public override NativeHandle ClassHandle { get { return class_ptr; } }
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public TSCellSeal () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected TSCellSeal (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal TSCellSeal (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public TSCellSeal (string passphrase)
			: base (NSObjectFlag.Empty)
		{
			...
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithPassphrase:"), nspassphrase), "initWithPassphrase:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("initWithPassphrase:"), nspassphrase), "initWithPassphrase:");
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NativeHandle ConstructorInitWithPassphraseData (NSData passphrase)
		{
			var passphrase__handle__ = passphrase!.GetNonNullHandle (nameof (passphrase));
			if (IsDirectBinding) {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithPassphraseData:"), passphrase__handle__);
			} else {
				return global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("initWithPassphraseData:"), passphrase__handle__);
			}
		}
		[Export ("autorelease")]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? Decrypt (NSData message, out NSError? error)
		{
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			NativeHandle errorValue = IntPtr.Zero;
			NSData? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("decrypt:error:"), message__handle__, ref errorValue))!;
			} else {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("decrypt:error:"), message__handle__, ref errorValue))!;
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		[Export ("decrypt:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? Decrypt (NSData message)
		{
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			if (IsDirectBinding) {
				return  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("decrypt:"), message__handle__))!;
			} else {
				return  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("decrypt:"), message__handle__))!;
			}
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? Encrypt (NSData message, out NSError? error)
		{
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			NativeHandle errorValue = IntPtr.Zero;
			NSData? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("encrypt:error:"), message__handle__, ref errorValue))!;
			} else {
				ret =  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (this.SuperHandle, Selector.GetHandle ("encrypt:error:"), message__handle__, ref errorValue))!;
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		[Export ("encrypt:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSData? Encrypt (NSData message)
		{
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			if (IsDirectBinding) {
				return  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("encrypt:"), message__handle__))!;
			} else {
				return  Runtime.GetNSObject<NSData> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("encrypt:"), message__handle__))!;
			}
		}
		[Export ("hash")]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
